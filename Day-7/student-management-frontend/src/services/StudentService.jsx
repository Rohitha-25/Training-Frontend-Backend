...
export const updateStudent = async(id, student) => await axios.put(`${API_URL}/update/${id}`, id, student);
export const deleteStudent = async(id) => await axios.delete(`${API_URL}/delete/${id}`, id);